...
def messageDisplay(message):
    ...
    move.pendown()
    move.write(message, font=('CALIBRE', 20, 'normal'))
    move.penup()
    move.setpos(-130, 200)
    move.pendown()
    move.write('click anywhere to continue', font=('CALIBRE', 10, 'normal'))
...
def endScreen(x, y):
    ...
    move.setpos(-50, 10)
    move.pendown()
    move.write('REPLAY', font=('CALIBRE', 20, 'normal'))
    move.penup()
    move.setpos(-30, -90)
    move.pendown()
    move.write('QUIT', font=('CALIBRE', 20, 'normal'))
...
def welcomeScreen():
    ...
    move.pendown()
    move.write('TIC TAC TOE', font=('CALIBRE', 40, 'normal'))
    move.pensize(5)
    move.penup()
    move.setposition(-70, -20)
    move.pendown()
    move.write('PLAY WITH', font=('CALIBRE', 20, 'normal'))
    move.pensize(5)
    move.penup()
    move.setposition(-60, -90)
    move.pendown()
    move.write('MACHINE', font=('CALIBRE', 20, 'normal'))
    move.pensize(5)
    move.penup()
    move.setposition(-47, -160)
    move.pendown()
    move.write('HUMAN', font=('CALIBRE', 20, 'normal'))
